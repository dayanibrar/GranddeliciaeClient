...
const stats = [
    ...
    { label: 'Visitors', value: '15589' },
    { label: 'Premiums', value: '5281' },
    { label: 'Value', value: '$34M' },
  ]

  
export default function ResortComp() {
    return (
                  ...
                  <blockquote className="mt-8">
                    <div className="relative text-lg font-medium text-white md:flex-grow">
                      ...
                      <p className="relative">
                       Entrepreneurs from all over the world spends their vacation on our private villa, islands, yatch and resorts.
                      </p>
                    </div>
  
                    <footer className="mt-4">
                      <p className="text-base font-semibold text-gray-200">Sarah Williams, CEO at Workcation</p>
                    </footer>
                  </blockquote>
                </div>
              </div>
          ...
          <div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                On a mission to make the dream come true
              </h2>
              <div className="mt-6 space-y-6 text-gray-500">
                <p className="text-lg">
                The Grand Deliciae is a 7-star luxury resort that offers a variety of high-end amenities and services to guests. The resort is known for its luxurious accommodations, fine dining options, and world-class spa facilities. Guests can also enjoy a range of recreational activities, such as swimming, tennis, and golf. Additionally, the resort offers a variety of customizable packages for events such as weddings and corporate meetings. Overall, The Grand Deliciae is a destination for those looking for the ultimate in luxury and relaxation.
                </p>
